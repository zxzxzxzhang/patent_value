...
class GAT(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels1, hidden_channels2, out_channels, heads=1, num_layers=3, dropout=0.5):
        ...
        self.conv1 = GATConv(in_channels, hidden_channels1, heads=heads)
        self.conv2 = GATConv(hidden_channels1 * heads, hidden_channels2, heads=heads)
        self.conv3 = GATConv(hidden_channels2 * heads, out_channels, heads=heads)
